...
/* BEGIN KYTY */
  if (fyty == 1)
  {
    ...
    {
    	keyMatrix[(0+i) >> 2][(0+i) & 3] ^= (21 >> i) | (21 << (8-i));
    	keyMatrix[(8+i) >> 2][(8+i) & 3] ^= (21 >> i) | (21 << (8-i));
    	keyMatrix[(16+i) >> 2][(16+i) & 3] ^= (21 >> i) | (21 << (8-i));
    	keyMatrix[(24+i) >> 2][(24+i) & 3] ^= (21 >> i) | (21 << (8-i));
    }
  }
/* END KYTY */
